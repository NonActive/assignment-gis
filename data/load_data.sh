...
# echo
# echo "# fetching ---->  $MESTSKE_CASTI"
# curl -S http://opendata.iprpraha.cz/CUR/DTMP/TMMESTSKECASTI_P/WGS_84/TMMESTSKECASTI_P_shp.zip > $MESTSKE_CASTI.zip

# echo

# unzip -o $MESTSKE_CASTI.zip
# rm $MESTSKE_CASTI.zip

# shp2pgsql -I -s 2263 *.shp $MESTSKE_CASTI |  PGPASSWORD='postgres' psql -U postgres -d pdt-postgis
# rm -f *

cd ..

PGPASSWORD='postgres' psql -U postgres -d pdt-postgis -a -f alter_tables.sql
